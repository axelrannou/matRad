...
patientName = 'john_doe_lung';

% Define the file path to the CSV file using patientName
csvFilePath = fullfile('/home/arannou/Documents/Workspace/matrad_env/matRad/userdata/patients', ...
    ['constraints_data_' patientName '.csv']);
...
%% Patient Data Import
% Automatically load the correct patient data file based on patientName
patientDataFile = fullfile('/home/arannou/Documents/Workspace/matrad_env/matRad/userdata/patients', ...
    [patientName '.mat']);

if ~exist(patientDataFile, 'file')
    error('Patient data file not found at: %s', patientDataFile);
end

fprintf('Loading patient data from: %s\n', patientDataFile);
...
pln.propStf.gantryAngles   = [0:4:359];
